...
- **ПЕРВАЯ ТОЧКА**: ОБЯЗАТЕЛЬНО начинай маршрут с точки, которая ближайшая к координатам startLocation (lat: ${answers.startLocation.lat}, lng: ${answers.startLocation.lng})
- **ГЕОГРАФИЯ**: Все места должны быть в радиусе разумного расстояния от startLocation. Не предлагай места в другом городе!
...
- Расстояния между точками: пешком max 2км, транспортом до 5км
